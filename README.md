# Streamdata.io API Gallery - BigBoulderInitiative Profiling
This is a repository for managing the profiling of BigBoulderInitiative. Right now, it is just a Github repository, README, and an [APIs.json](apis.md) outlining some of the details of BigBoulderInitiative, including different links and artificats defining their operation.
...
Once there is an OpenAPI for BigBoulderInitiative, it will be available within the [Streamdata.io API Gallery](http://api.gallery.streamdata.io/), until then the companies profile will be used in a variety of other sites and applications.
